 ...
 <Worksheet ss:Name="Sheet1">
  <Table ss:ExpandedColumnCount="12" ss:ExpandedRowCount="500" x:FullColumns="1"
   ...
   <Row>
    ...
    <Cell><Data ss:Type="String">籍贯</Data></Cell>
    ...
    <Cell><Data ss:Type="String">第一志愿</Data></Cell>
    <Cell><Data ss:Type="String">第二志愿</Data></Cell>
   </Row>
   <#list apts as apt>
   <Row>
    <Cell><Data ss:Type="String">${apt.studentNum}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.name}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.gender}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.polity}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.nation}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.place}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.yyyyMMdd}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.clazz}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.phone}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.qq}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.aptFirstTag.deptName}</Data></Cell>
    <Cell><Data ss:Type="String">${apt.aptSecondTag.deptName}</Data></Cell>
   </Row>
   </#list>
  </Table>
