      			...
      			<ul class="nav">
      				<li class="active">
          				...
          				<ul class="collapse control-menu in" id="applicationFormControl">
            				...
            				<li class="active"><a href="cadHandleSixThree">第三次面试</a></li>
			...
			<div class="row right-bar-cont">
				<div class="form-table col-sm-12">
					<div class="manage-menu clearfix">
						<ul class="clearfix">
							<li><a href="cadHandleSixThree">未处理</a></li>
							<li><a href="cadHandleEightThree">已通过</a></li>
							<li><a href="cadHandleNineThree">未通过</a></li>
							<li class="active"><a href="cadHandleSixThreeAdjusted">已调剂</a></li>
						</ul>
					</div>
					<div class="searchCont clearfix">
						<form action="cadHandleSixThreeAdjusted">
					...
					<div class="manage-cont" >
						...
						<s:iterator value="#request.pageBean">
							<div class="paging">
								...
								<s:else>
									<a href="cadHandleSixThreeAdjusted?page=1&name=<s:property value="#parameters.name[0]"/>">首页</a>
									<a href="cadHandleSixThreeAdjusted?page=<s:property value="%{cp-1}"/>&name=<s:property value="#parameters.name[0]"/>">上一页</a>
								</s:else>
								...
								<s:else>
									<a href="cadHandleSixThreeAdjusted?page=<s:property value="#i"/>&name=<s:property value="#parameters.name[0]"/>">${i }</a>
								</s:else>
								</s:iterator>
								
								<s:if test="%{cp < tp}">
									<a href="cadHandleSixThreeAdjusted?page=<s:property value="%{cp+1}"/>&name=<s:property value="#parameters.name[0]"/>">下一页</a>
									<a href="cadHandleSixThreeAdjusted?page=<s:property value="tp"/>&name=<s:property value="#parameters.name[0]"/>">尾页</a>
								</s:if>
								<s:else>
 					        		<span>下一页</span>
									<span>尾页</span>
