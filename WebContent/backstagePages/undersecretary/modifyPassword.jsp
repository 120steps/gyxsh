...
<title>管理后台-${session_user.student.merDepartment.deptName }-个人设置-修改密码</title>
		...
		<div class="row right-bar-cont">
			<div class="form-table col-sm-12">
				<div class="manage-menu clearfix">
					<ul class="clearfix">
						<li><a href="cadModifyBasicInfo">基本信息</a></li>
						<li class="active"><a href="#">修改密码</a></li>
					</ul>
				</div>
				<div class="infoCont">
					<form class="form-horizontal" method="post" name="changePasswordForm" action="cadChangePassword">
