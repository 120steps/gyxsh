			...
			<div class="form-table col-sm-12">
				<div class="manage-menu clearfix">
					<ul class="clearfix">
						...
						<li><a href="${pageContext.request.contextPath }/backstagePages/undersecretary/modifyPassword.jsp">修改密码</a></li>
					</ul>
				</div>
				<div class="infoCont">
					<form class="form-horizontal" method="post" action="cadSaveBasicInfo" name="basicInfoForm">
							...
							<div class="col-sm-6">
								<div class="input-group inputDiv">
									<input type="text" id="birthday" name="birth" class="form-control"
										placeholder="如：1995-01-01" value='<s:date name="#request.member.birth" format="yyyy-MM-dd"/>'/> 
						...
						<div class="form-group">
							...
							<div class="col-sm-6 inputDiv">
								<input type="text" class="form-control" id="phoneNumber" name="phone" value="${member.phone }">
							</div>
