...
<html>
	<head>
		...
		<title>管理后台-${session_user.student.merDepartment.deptName }-开启报名系统</title>
      			...
      			<ul class="nav">
        			...
        			<li class="active">
          				...
          				<ul class="collapse control-menu in" id="applySysControl">
           					<li class="active"><a href="secEnrollTimeShow">开启报名系统</a></li>
		...
		<div class="modal fade bs-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  			<div class="modal-dialog" role="document">
    			<div class="modal-content">
      				...
      				<form class="form-horizontal" action="secEnrollTimeSet" name="timeForm">
