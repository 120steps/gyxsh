...
<html>
	<head>
		...
		<title>管理后台-${session_user.student.merDepartment.deptName }-开启处理系统</title>
      			...
      			<ul class="nav">
        			...
        			<li class="active">
          				...
          				<ul class="collapse control-menu in" id="applySysControl">
            				...
            				<li class="active"><a href="secDisposeTimeShow">开启处理系统</a></li>
          				</ul>
        			</li>
			...
			<div class="content">
				<div class="timeCont">
					<div class="timeItem clearfix">
						...
						<label class="col-sm-6"><s:date name="#request.disposeTime.begin" format="yyyy-MM-dd HH:mm"/></label>
					</div>
					<div class="timeItem clearfix">
						<label class="col-sm-6 itemLeft">结束时间：</label>
						<label class="col-sm-6"><s:date name="#request.disposeTime.end" format="yyyy-MM-dd HH:mm"/></label>
					</div>
					<div class="timeItem clearfix">
  			...
  			<div class="modal-dialog" role="document">
    			<div class="modal-content">
      				<div class="modal-header">
        				...
        				<h4 class="modal-title" id="myModalLabel">设置处理时间</h4>
      				</div>
      				<form class="form-horizontal" action="secDisposeTimeSet" name="timeForm">
  								...
  								<div class="col-sm-6">
      								<div class="input-group">
      									<input type="text" id="beginTime" name="begin" class="form-control" placeholder="如：1995-01-01"
      									 value='<s:date name="#request.disposeTime.begin" format="yyyy-MM-dd HH:mm"/>'/>
  								...
  								<div class="col-sm-6">
      								<div class="input-group">
      									<input type="text" id="stopTime" name="end" class="form-control" placeholder="如：1995-01-01"
      									  value='<s:date name="#request.disposeTime.end" format="yyyy-MM-dd HH:mm"/>'/>
      									<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
      								</div>
    							</div>
