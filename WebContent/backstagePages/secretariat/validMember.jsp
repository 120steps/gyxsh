...
<html>
	<head>
		...
		<title>管理后台-${session_user.student.merDepartment.deptName }-现有成员</title>
      			...
      			<ul class="nav">
        			...
        			<li class="active">
          				...
          				<ul class="collapse control-menu in" id="memberControl">
            				...
            				<li class="active"><a href="secShowMemberAble">现有成员</a></li>
					...
					<div class="manage-cont" >
  												...
  												<div class="modal-dialog" role="document">
								    				<div class="modal-content">
      													...
      													<div class="modal-footer">
      														<form action="secShowMemberAbleOut">
						...
						<s:iterator value="#request.pageBeanMember">
							<div class="paging">
								...
								<s:else>
									<a href="secShowMemberAble?page=1">首页</a>
									<a href="secShowMemberAble?page=<s:property value="%{cp-1}"/>">上一页</a>
								</s:else>
								...
								<s:else>
									<a href="secShowMemberAble?page=<s:property value="#i"/>">${i }</a>
								</s:else>
								</s:iterator>
								
								<s:if test="%{cp < tp}">
									<a href="secShowMemberAble?page=<s:property value="%{cp+1}"/>">下一页</a>
									<a href="secShowMemberAble?page=<s:property value="tp"/>">尾页</a>
								</s:if>
								<s:else>
 					        		<span>下一页</span>
									<span>尾页</span>
