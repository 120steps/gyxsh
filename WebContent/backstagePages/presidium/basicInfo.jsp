...
<title>管理后台-主席团-个人设置-基本信息</title>
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/backstageCss/basicInfo.css" />
</head>
<body>
			...
			<div class="user-menu pull-right">
				<div class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						...
						<li><a href="merModifyBasicInfo"><i
	...
	<div class="collapse navbar-collapse leftMenu col-sm-3 col-lg-2"
		...
		<div class="leftMenuCont">
			<ul class="nav">
				<li><a href="#applicationFormControl" data-toggle="collapse"
					role="button" aria-haspopup="true" aria-expanded="false">报名表管理<i
			...
			<div class="form-table col-sm-12">
				<div class="manage-menu clearfix">
					<ul class="clearfix">
						...
						<li><a href="${pageContext.request.contextPath }/backstagePages/presidium/modifyPassword.jsp">修改密码</a></li>
					</ul>
				</div>
				<div class="infoCont">
					<form class="form-horizontal" method="post" action="merSaveBasicInfo" name="basicInfoForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="input-group inputDiv">
									<input type="text" id="birthday" name="birth" class="form-control" placeholder="如：1995-01-01" value='<s:date name="#request.member.birth" format="yyyy-MM-dd"/>'/> 
						...
						<div class="form-group">
							...
							<div class="col-sm-6 inputDiv">
								<input type="text" class="form-control" id="studentNum" name="studenNum"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/backstageJs/basicInfo.js"></script>
</body>
</html>
