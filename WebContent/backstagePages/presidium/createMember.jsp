...
<html>
	...
	<body>
      			...
      			<ul class="nav">
        			...
        			<li class="active">
          				...
          				<ul class="collapse control-menu in" id="memberControl">
           					<li class="active"><a href="merCreateMember">新增成员</a></li>
			...
			<div class="row right-bar-cont">
				<div class="form-table col-sm-12">
					<div class="createCont">
						<form class="form-horizontal" action="merCreateMemberSave" method="post" name="createForm">
							<div class="form-group">
    							...
    							<label class="col-sm-3 control-label danger-label">${errors.member }</label>
  							</div>
  							<div class="form-group">
    							<label for="majorAndClass" class="col-sm-3 control-label">专业班级：</label>
    							<div class="col-sm-6">
      								<input type="text" class="form-control" id="majorAndClass" name="clazz" placeholder="如：信管1301班"
      								 value="${member.clazz }">
    							</div>
  							...
  							<div class="form-group">
    							...
    							<div class="col-sm-6">
      								<input type="text" class="form-control" id="userAccount" name="studentNum" placeholder="如：0121303490113"
      								 vlaue="${member.studentNum }">
    							</div>
  							...
  							<div class="form-group">
    							...
    							<div class="col-sm-6">
      								<select id="department" name="merDepartment.deptId" class="selectpicker form-control show-tick" data-size="5">
      									<option <s:if test="#request.member.merDepartment.deptId==null">selected</s:if> value="0">请选择部门...</option>
      									<s:iterator value="#request.departments">
											<option <s:if test="#request.member.merDepartment.deptId==deptId">selected</s:if> value="${deptId }">${deptName }</option>
										</s:iterator>
      								</select>
    							</div>
    							<label class="col-sm-3 control-label danger-label">${errors.merDepartment }</label>
  							</div>
  							<div class="form-group">
    							<label for="jurisdiction" class="col-sm-3 control-label">权限：</label>
    							<div class="col-sm-6">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/backstageJs/presidium-createMember.js" ></script>
	</body>
</html>
