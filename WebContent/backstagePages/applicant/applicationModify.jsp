...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/backstageCss/applicationModify.css" />
	</head>
	<body>
    	...
    	<div class="collapse navbar-collapse leftMenu col-sm-3 col-lg-2" id="bs-example-navbar-collapse-1">
    	 	<div class="leftMenuCont">
      			<ul class="nav">
        			...
        			<li class="active"><a href="aptModify">报名表修改</a></li>
      			</ul>
      		</div>
      		<div class="footer">
      			<p>309工作室</p>
		...
		<div class="right-bar col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
			<div class="row path">
				<ol class="breadcrumb">
  					...
  					<li class="active">报名表修改</li>
				</ol>
			</div>
			<div class="right-content">
				<div class="form-content clearfix">
					<form class="form-horizontal col-sm-10 col-sm-offset-2" method="post" name="modifyAptForm"
			 action="aptModifySave" enctype="multipart/form-data">
					<h3>基本信息</h3>
					<div class="apImage">
  						<p class="img-title">个人照片</p>
  						<img src="${pageContext.request.contextPath}/${applicant.imgSrc }" />
  						<p><button class="img-btn" type="button"><i class="fa fa-plus-square"></i> 上传照片</button></p>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6 inputDiv">
      						<input type="text" class="form-control" id="name" name="name" placeholder="如：张三" value="${applicant.name }">
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6 inputDiv">
      						<input type="text" class="form-control" id="native" name="place" placeholder="如：湖北省武汉市" value="${applicant.place }">
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6">
      						<select id="politics-status" name="polity" class="selectpicker form-control show-tick" data-size="5">
      							<option
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6">
      						<select id="nation" name="nation" class="selectpicker form-control show-tick" data-live-search="true" data-size="5">
      						<option
  					...
  					<div class="form-group">
  						...
  						<div class="col-sm-6">
      						<div class="input-group inputDiv">
      							<input type="text" id="birthday" name="birth" class="form-control" placeholder="如：1995-01-01" value='<s:date format="yyyy-MM-dd" name="#request.applicant.birth"/>'/>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6 inputDiv">
      						<input type="text" class="form-control" id="majorAndClass" name="clazz" placeholder="如：信管1301班" value="${applicant.clazz }">
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6 inputDiv">
      						<input type="text" class="form-control" id="studentNum" name="studentNum" placeholder="如：0121303490113"
      						 value="${applicant.studentNum }" disabled="disabled">
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6 inputDiv">
      						<input type="text" class="form-control" id="dormitory" name="dormitory" placeholder="如：南4-309" value="${applicant.dormitory }" >
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6 inputDiv">
      						<input type="text" class="form-control" id="phoneNumber" name="phone" value="${applicant.phone }">
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6 inputDiv">
      						<input type="text" class="form-control" id="qq" name="qq" value="${applicant.qq }">
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6">
      						<select id="seconddepartment" name="aptSecondTag_id" class="selectpicker form-control show-tick" data-size="5">
      							<option
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6">
      						<textarea class="form-control" id="otherDepartment" name="aptOtherOrg" rows="1" placeholder="没有就填“无”" >${applicant.aptOtherOrg }</textarea>
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6">
      						<textarea class="form-control" id="speciality" name="aptSpeciality" rows="1" >${applicant.aptSpeciality }</textarea>
    					</div>
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-6">
      						<textarea class="form-control" id="interest" name="aptInterest" rows="1" >${applicant.aptInterest }</textarea>
    					</div>
    					<label class="col-sm-4 control-label danger-label">${errors.aptInterest }</label>
  					</div>
  					<div class="form-group">
  						<label for="workExperience" class="col-sm-2 control-label">工作经历：<br>（简述工作经历，获奖情况等）</label>
    					<div class="col-sm-6">
      						<textarea class="form-control" id="workExperience" name="aptExperience" rows="10" >${applicant.aptExperience }</textarea>
    					</div>
    					<label class="col-sm-4 control-label danger-label">${errors.aptExperience }</label>
  					</div>
  					<div class="form-group">
  						<label for="cognition" class="col-sm-2 control-label">对学生会的认识：<br>（你对学生会有什么了解？）</label>
    					<div class="col-sm-6">
      						<textarea class="form-control" id="cognition" name="aptKnow" rows="8" >${applicant.aptKnow }</textarea>
    					</div>
    					<label class="col-sm-4 control-label danger-label">${errors.aptKnow }</label>
  					</div>
  					<div class="form-group">
  						<label for="outlook" class="col-sm-2 control-label">工作展望：<br>（结合你竞选的部门，谈谈你对该部门工作的理解和创新）</label>
    					<div class="col-sm-6">
      						<textarea class="form-control" id="outlook" name="aptExpectation" rows="8">${applicant.aptExpectation }</textarea>
    					</div>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/backstageJs/applicationModify.js" ></script>
	</body>
</html>
