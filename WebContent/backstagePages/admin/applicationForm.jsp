...
<body>
	<div class="formCont container">
			...
			<form class="form-horizontal col-sm-10 col-sm-offset-2" method="post" name="modifyAptForm"
			 action="adminAptModify" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<div class="input-group inputDiv">
							<input type="text" id="birthday" class="form-control" name="birth"
								placeholder="如：1995-01-01" value='<s:date format="yyyy-MM-dd" name="#request.applicant.birth"/>' /> <span
				...
				<div class="form-group">
					...
					<div class="col-sm-6 inputDiv">
						<input type="text" class="form-control" id="majorAndClass" name="clazz"
							placeholder="如：信管1301班" value="${applicant.clazz }">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 inputDiv">
						<input type="text" class="form-control" id="studentNum" name="studentNum"
							placeholder="如：0121303490113" value="${applicant.studentNum }">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 inputDiv">
						<input type="text" class="form-control" id="dormitory" name="dormitory"
							placeholder="如：南4-309" value="${applicant.dormitory }">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea class="form-control" id="otherDepartment" name="aptOtherOrg" rows="1"
							placeholder="没有就填“无”">${applicant.aptOtherOrg }</textarea>
					</div>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/backstageJs/adminApplicationForm.js"></script>
</body>
</html>
