...
<html>
	...
	<body>
      			...
      			<ul class="nav">
        			...
        			<li class="active">
          				...
          				<ul class="collapse control-menu in" id="memberControl">
           					<li class="active"><a href="adminCreateMember">新增成员</a></li>
			...
			<div class="row right-bar-cont">
				<div class="form-table col-sm-12">
					<div class="createCont">
						<form class="form-horizontal" action="adminCreateMemberSave" method="post" name="createForm">
  							...
  							<div class="form-group">
    							...
    							<div class="col-sm-6">
      								<input type="text" class="form-control" id="userAccount" name="studentNum"
      								 placeholder="如：0121303490113" value="${member.studentNum }">
    							</div>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/backstageJs/checkPosition.js"></script>
	</body>
</html>
